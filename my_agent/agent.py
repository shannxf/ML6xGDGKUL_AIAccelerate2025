...
from my_agent.tools import web_search, web_research, image_ops, calculator, get_time, grid_extractor, string_reasoner, code_reasoner
...
fast_agent = llm_agent.Agent(
    ...
    tools=[web_search, web_research, image_ops, calculator, get_time,grid_extractor,string_reasoner,code_reasoner],
    sub_agents=[],
)
